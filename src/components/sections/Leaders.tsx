...
const leaders = [
  ...
  { name: "Naveen", role: "Tech & Training Manager", img: "/Naveen (1).png", linkedin: "https://www.linkedin.com/in/naveend2005/", note: "Leading technical training & team development." },
];
