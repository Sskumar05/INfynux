...
const SERVICES_DATA: Record<string, any> = {
  "web-development": {
    ...
    intro: "Website development is the comprehensive process of building, creating, and maintaining websites. At Rubi Royals, we view a website as the digital cornerstone of your brand. It's not just about aesthetics; it's about engineering a high-performance platform that works for your business 24/7.",
