...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy | Rubi Royals" },
      { name: "description", content: "Learn how Rubi Royals collects, uses, and protects your personal information. Your privacy is our priority." },
      { property: "og:title", content: "Privacy Policy | Rubi Royals" },
      { property: "og:description", content: "Learn how Rubi Royals collects, uses, and protects your personal information." },
    ...
    <LegalLayout title="Privacy Policy" lastUpdated="May 16, 2026" icon="privacy">
      <div className="space-y-12 text-muted-foreground leading-relaxed">
        <section>
          ...
          <p>
            At Rubi Royals, we are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
          </p>
        </section>
