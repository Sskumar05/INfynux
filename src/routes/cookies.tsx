  ...
  return (
    <LegalLayout title="Cookie Policy" lastUpdated="May 16, 2026" icon="cookies">
      <div className="space-y-12 text-muted-foreground leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Analytics Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Functional Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4">Marketing Cookies</h2>
          <p>
