    ...
    <section id="home" className="relative lg:min-h-screen flex items-center justify-center pt-28 lg:pt-32 pb-16 lg:pb-24">
      ...
      <div className="relative z-10 text-center site-container flex flex-col items-center">
        ...
        <div data-aos="fade-up" data-aos-delay="200" className="mt-6 flex flex-wrap items-center justify-center gap-2 max-sm:gap-y-3.5">
          ...
          <span className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] text-white/90 inline-flex rounded-full px-3.5 py-1.5 text-xs font-medium">Fast Delivery</span>
          <span className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] text-white/90 inline-flex rounded-full px-3.5 py-1.5 text-xs font-medium">Scalable Solutions</span>
        </div>

        <div data-aos="fade-up" data-aos-delay="300" className="mx-auto mt-8 sm:mt-10 grid w-[90%] max-w-3xl grid-cols-2 gap-2 sm:gap-3 md:grid-cols-4 lg:gap-3">
          {stats.map((s, i) => (
            <div key={s.label} className="bg-white/10 backdrop-blur-2xl border border-white/20 border-t-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.3)] rounded-2xl sm:rounded-3xl px-2 py-3 sm:px-5 sm:py-6 text-center hover-lift relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-br from-white/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="font-display tabular-nums text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-white drop-shadow-md">
                <Counter end={s.v} suffix={s.suf} />
              </div>
              <div className="text-white/80 mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium uppercase tracking-wider">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="mt-12 flex flex-col items-center justify-center gap-6 lg:flex-row lg:gap-10 w-full max-w-3xl mx-auto">
          <div className="flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row">
            ...
            <a href="#services" className="group inline-flex shrink-0 items-center justify-center gap-2 rounded-full font-medium transition-transform hover:scale-[1.03] bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] text-white hover:bg-white/20 h-12 w-full px-5 py-3 text-sm sm:h-auto sm:w-auto sm:min-h-[44px]">
              Explore Universe <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 transition-transform" />
            </a>
          </div>
          
          <div className="bg-white/20 hidden h-11 w-px shrink-0 lg:block" aria-hidden="true"></div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
             <a
              ...
              className="inline-flex items-center gap-2.5 rounded-2xl px-3 py-2.5 sm:px-4 sm:py-3 bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] hover:bg-white/20 transition-all"
             >
               <span className="grid size-6 sm:size-8 shrink-0 place-items-center rounded-xl bg-[#25D366]/20 px-1 border border-[#25D366]/30 shadow-[0_0_15px_rgba(37,211,102,0.3)]">
                 <svg viewBox="0 0 24 24" fill="#25D366" className="h-4 w-4 sm:h-5 sm:w-5 drop-shadow-md"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" /></svg>
               </span>
               <span className="text-left">
                 <span className="text-white block text-[13px] sm:text-sm font-semibold leading-none drop-shadow-md">WhatsApp</span>
                 <span className="mt-0.5 sm:mt-1 block text-[10px] sm:text-xs font-medium leading-none text-white/80">Chat with us</span>
               </span>
             </a>
          </div>
        </div>
