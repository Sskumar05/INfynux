...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Rubi Royals " },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div className="relative">
          <div className="h-16 w-16 rounded-full border-2 border-[var(--cyan)] border-t-transparent animate-spin" />
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div data-aos="fade-up" className="inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-xs uppercase tracking-widest text-[var(--cyan)] mb-8">
        ...
        <p data-aos="fade-up" data-aos-delay="200" className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
          Rubi Royals transforms ideas into high-performance websites, intelligent applications, and next-generation digital products.
        </p>
        ...
        {/* <div data-aos="fade-up" data-aos-delay="500" className="mt-20 mx-auto max-w-3xl">
          <div className="relative rounded-3xl glass-strong p-2 glow-cosmic">
              ...
              <div className="grid grid-cols-3 gap-6 text-left">
                {[
                  ...
                  <div key={s.k}>
                    ...
                    <div className="text-sm sm:text-base font-medium mt-1">{s.v}</div>
                  </div>
                ))}
              </div>
            </div>
...
/* ---------- TRUSTED ---------- */
function TrustedBy() {
  const brands = ["Google", "Microsoft", "OpenAI", "Vercel", "Stripe", "Figma"];
  return (
    <section className="py-16 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p data-aos="fade-up" className="text-center text-xs uppercase tracking-[0.3em] text-muted-foreground mb-10">
          Trusted by visionaries across the galaxy
        </p>
        <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-center">
          {brands.map((b, i) => (
            <div
              ...
              data-aos="fade-up"
              data-aos-delay={i * 80}
              className="text-center font-display text-xl sm:text-2xl font-bold text-muted-foreground/60 hover:text-[var(--cyan)] transition-colors cursor-default"
            >
              {b}
            </div>
          ))}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div data-aos="fade-up" className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold font-display leading-tight mb-6">
            Our Strategy for <span className="text-gradient-cosmic">Your Success</span> with Rubi Royals
          </h2>
